%% settings_convInterContr_robot
% algorithm settings for the robot
% benchmark
%
%% Syntax
%
% <html>
%        <div class="syntax">
% Opts = settings_convInterContr_robot() <br>
%        </div>
% </html>
%
%% Description
% Algorithm settings and parameter for the Convex Interpolation
% Control Algorithm for the robot benchmark.
%
%% Output Arguments
%
%
...
%
%% See Also
% <convexInterpolationControlhelp.html |convexInterpolationControl|>, <robothelp.html |robot|>
%
