function R = shiftOccupancySet_quadrotor2D(R,xf,time)
% SHIFTOCCUPANCYSET_QUADROTOR2D - shift occupupancy set to final state of 
%                                 previous maneuver
%
% Syntax:
%       R = SHIFTOCCUPANCYSET_QUADROTOR2D(R,xf,time)
%
% Description:
