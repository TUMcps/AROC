...
%       controlled with the Polynomial Controller for multiple
%       random initial points and randomly drawn disturbance values.
%
% Input Arguments:
%
%       -obj:           object of class objPolyContr storing the 
