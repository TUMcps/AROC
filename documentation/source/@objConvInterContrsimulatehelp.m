...
%    <td>
%        <p class="table">
%            object of class objConvInterContr storing the control law
...
%
%% See Also
% <convexInterpolationControlhelp.html |convexInterpolationControl|>, <simulateRandomhelp.html |simulateRandom|>
%
