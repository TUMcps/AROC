%% objGenSpaceContr
% construct a controller object for the synthesis
...
% <html>
%        <div class="syntax">
% obj = OBJGENSPAECONTR(dyn,Rfin,contrLaw,Param) <br>
% obj = OBJGENSPAECONTR(dyn,Rfin,contrLaw,Param,occSet) <br>
%        </div>
% </html>
%
%% Description
...
%    <td>
%        <p class="table">
%            cell-array storing the factors alpha of the control
...
%    <td>
%        <p class="table">
%            cell-array storing a parallelotope enclosure of the
...
%    <td>
%        <p class="table">
%            resulting object of class objGenSpaceContr
%        </p>
%    </td>
%    </tr>
% </tbody>
