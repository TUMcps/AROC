...
% <html>
%        <div class="syntax">
% objContr = convexInterpolationControl(benchmark,Param) <br>
% objContr = convexInterpolationControl(benchmark,Param,Opts) <br>
% objContr = convexInterpolationControl(benchmark,Param,Opts,Post) <br>
%        </div>
% </html>
%
%% Description
...
%
%% See Also
% <objConvInterContrhelp.html |objConvInterContr|>
%
%% References
