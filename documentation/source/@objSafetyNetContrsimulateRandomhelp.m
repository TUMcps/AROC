...
% <html>
%        <div class="syntax">
% [res,t,x,u,flag] = simulateRandom(obj,res,Npoints,fracVert,fracDistVert,distChanges) <br>
%        </div>
% </html>
%
%% Description
...
%    <td>
%        <p class="table">
%            cell-array storing a flag that specifies which controller
...
%
%% See Also
% <safetyNetControlhelp.html |safetyNetControl|>, <simulatehelp.html |simulate|>
%
