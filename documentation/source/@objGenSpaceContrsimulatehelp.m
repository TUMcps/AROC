...
% <html>
%        <div class="syntax">
% [res,t,x,u] = simulate(obj,res,x0,w) <br>
%        </div>
% </html>
%
%% Description
...
%    <td>
%        <p class="table">
%            object of class objGenSpaceContr storing the control law
...
%    <td>
%        <p class="table">
%            matrix storing the control inputs for the simulated
%            trajectory (dimension: [<tt>t</tt>,nu])
%        </p>
%    </td>
%    </tr>
% </tbody>
...
%
%% See Also
% <matlab:doc('generatorSpaceContr') generatorSpaceContr>, <simulateRandomhelp.html |simulateRandom|>
%
%% References
