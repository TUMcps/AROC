function [res,t,x] = simulateRandom(obj,res,Npoints,fracVert,fracDistVert,distChanges)
...
%               trajectories
%       -u:     cell-array storing the matrices with all applied control
%               inputs
%
% See Also:
