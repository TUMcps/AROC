%% settings_convInterContr_cart
% algorithm settings for the cart benchmark
%
%% Syntax
%
% <html>
%        <div class="syntax">
% Opts = settings_convInterContr_cart() <br>
%        </div>
% </html>
%
%% Description
% Algorithm settings and parameter for the Convex Interpolation
% Control Algorithm for the cart benchmark.
%
%% Output Arguments
%
%
...
%
%% See Also
% <convexInterpolationControlhelp.html |convexInterpolationControl|>, <carthelp.html |cart|>
%
