...
% <html>
%        <div class="syntax">
% [u,x] = optimalControl(system,xf,vert,h,Q,R,steps,lenHorizon) <br>
%        </div>
% </html>
%
%% Description
...
%
%% See Also
% <convexInterpolationControlhelp.html |convexInterpolationControl|>, <localCornerControlhelp.html |localCornerControl|>
%
%% References
