function Opts = settings_convInterContr_platoon()
% SETTINGS_CONVINTERCONTR_PLATOON - algorithm settings for the platoon
%                                   benchmark 
%
% Syntax:
...
%------------------------------------------------------------------
    ...
    % number of reference trajectory and intermediate time steps
    Opts.N = 25;
    Opts.Ninter = 1;
    
    % weighting matrices for the cost function (reference trajectory)
    Opts.refTraj.Q = eye(8);             
    Opts.refTraj.R = zeros(4); 
