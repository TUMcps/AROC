...
% controlled with the Generator Space Controller for multiple
...
%    <td>
%        <p class="table">
%            cell-array storing the matrices with the applied control
...
%
%% See Also
% <generatorSpaceControlhelp.html |generatorSpaceControl|>, <simulatehelp.html |simulate|>
%
