function Param = param_car_decelerate()
% PARAM_CAR_DECELERATE - parameters for the car benchmark
%
% Syntax:
%       Param = PARAM_CAR_DECELERATE()
%
% Description:
%       Parameters of the decelerate maneuver for the car benchmark. The 
