%% plotReach
% plot the computed reachable set
%
%% Syntax
%
% <html>
%        <div class="syntax">
% han = plotReach(obj) <br>
% han = plotReach(obj,dim) <br>
% han = plotReach(obj,dim,color) <br>
% han = plotReach(obj,dim,color,options) <br>
%        </div>
% </html>
%
%% Description
...
%
%% See Also
% <resultshelp.html |results|>, <plotReachTimePointhelp.html |plotReachTimePoint|>, <plotSimulationhelp.html |plotSimulation|>
%
