function Param = param_car_driveStraight()
% PARAM_CAR_DRIVESTRAIGHT - parameters for the car benchmark
%
% Syntax:
%       Param = PARAM_CAR_DRIVESTRAIGHT()
%
% Description:
%       Parameters of the drive staight maneuver for the car benchmark. The 
