function Opts = settings_optBasedContr_platoon()
% SETTINGS_OPTBASEDCONTR_PLATOON - algorithm settings for the platoon 
%                                  benchmark 
%
% Syntax:
...
%       algorithm for the platoon benchmark
%
% Output Arguments:
%
